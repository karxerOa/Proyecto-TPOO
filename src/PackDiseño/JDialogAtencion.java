...
public class JDialogAtencion extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, 268, 124));

        jLabel9.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel9.setText("Alergias:");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 310, 66, 26));
    ...
    private void btnTerminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTerminarActionPerformed
        try {
            Receta recetanueva = new Receta(txtMedicamentosDosis.getText(), txtRecomendaciones.getText());
            Diagnostico diag = new Diagnostico(txtSintomas.getText(), txtEnfermedadDiagnosticada.getText());
