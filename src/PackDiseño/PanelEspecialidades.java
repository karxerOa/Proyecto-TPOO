...
public class PanelEspecialidades extends javax.swing.JPanel {
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        try{
            ControladorAdministrador CA = new ControladorAdministrador();
            Especialidad esp = CA.BuscarEspecialidad(txtBuscarEspecialdiad.getText());
            if(esp !=null){
            labelNombre.setText(esp.getNombre());
            TEXTDESCRIPCION.setText(esp.getDescripcion());
            JOptionPane.showMessageDialog(this, "Especialdiad Encontrada");
            }
            else{
            JOptionPane.showMessageDialog(this, "Especialdiad no Encontrada");
            }
